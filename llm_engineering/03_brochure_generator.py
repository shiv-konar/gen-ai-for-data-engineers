...
def get_links_system_prompt():
    """One Shot Prompting - where we provide one example for the expected output from the model"""
...
# create_brochure("Hugging Face", "https://www.huggingface.co")
create_brochure("Vajreshwari Das", "https://www.vajreshwaridas.com")
